                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                           <?php
                            ...
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Escribe aquí el número de DNI del docente" name="teachingDUI" pattern="[0-9-]{1,10}" required="" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solamente números y guiones, 10 dígitos">
