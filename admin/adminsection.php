                       ...
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                ...
                                <select class="material-control tooltips-general" name="sectionSpecialty" data-toggle="tooltip" data-placement="top" title="Elige la especialidad">
                                    <option value="" disabled="" selected="">Selecciona una opción</option>
                                    <option value="Asistente Ad. ">Docente.</option>
                                    <option value="Contador ">Asistente</option>
                                    <option value="Enfermería ">Docente</option>
                                    <option value="General ">General</option>
                                    <option value="Mecánica A. ">Asistente</option>
                                </select>
                            </div>
                            <div class="group-material">
                                <span>Sección</span>
