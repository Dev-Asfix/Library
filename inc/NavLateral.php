...
<div class="navbar-lateral full-reset">
    ...
    <div class="full-reset container-menu-movile custom-scroll-containers">
        ...
        <div class="full-reset" style="background-color:#2B3D51; padding: 10px 0; color:#fff;">
            <figure>
                <img src="<?php echo $LinksRoute; ?>assets/img/logo.gif" alt="Biblioteca" class="img-responsive center-box img-circle" style="width:55%;">
            </figure>
            <p class="text-center" style="padding-top: 15px;">IESTP HERCAR</p>
        </div>
